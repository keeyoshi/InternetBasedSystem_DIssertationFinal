...
import com.keeyoshi.internetbasedservice.Activity.LoginActivity;
...
public class AdminRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateAccountButton = (Button) findViewById(R.id.admin_register_btn);
        InputName = (EditText) findViewById(R.id.register_admin_input);
        InputPassword = (EditText) findViewById(R.id.register_admin_password_input);
        InputPhoneNumber = (EditText) findViewById(R.id.register_admin_phone_number_input);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!(dataSnapshot.child("Admins").child(phone).exists())){
                    ...
                    Toast.makeText(AdminRegisterActivity.this, "This " + phone + " already exists.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
